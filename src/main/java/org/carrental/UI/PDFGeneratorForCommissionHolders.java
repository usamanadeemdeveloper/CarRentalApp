...
public class PDFGeneratorForCommissionHolders {
    public PDFGeneratorForCommissionHolders(JTable jTable, String pdfName, Double totalAmount, List<VehicleOwner> commissionList) throws Exception {
